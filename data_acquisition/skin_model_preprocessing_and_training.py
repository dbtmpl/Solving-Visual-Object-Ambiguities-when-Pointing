...
def calc_bayesian_hist(hist_skin, hist_no_skin):
    ...
    print "min - max"
    print "Skin hist"
    print np.max(p_c_skin)
    print np.min(p_c_skin)
    print "No skin hist"
    print np.max(p_c_noskin)
    print np.min(p_c_noskin)
...
def train_crcb_2d_hist():
    ...
    print "min - max"
    print "Skin hist"
    print np.max(crcb_skin_hist)
    print np.min(crcb_skin_hist)
    print "No skin hist"
    print np.max(crcb_no_skin_hist)
    print np.min(crcb_no_skin_hist)
