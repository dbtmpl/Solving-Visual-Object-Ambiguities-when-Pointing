import cv2 as cv
import numpy as np
from engine import gesture_detection as gesture
    ...
    if fingertips.shape[0] == 1:
        ...
        if defect_count <= 2:
            if pointing_estimation:
                ...
                frame, frame2 = gesture.predict_gwr_pointing(frame, frame2, hand, fingertip, (icx, icy), gwr,
                                                             hand_positions_t0)
        ...
        if hand_d[0].shape[0] == 1:
            ...
            if defect_count <= 2:
                if pointing_estimation:
                    ...
                    frame, frame2 = gesture.predict_gwr_pointing(frame, frame2, hand_d[4], fingertip, hand_d[2], gwr,
                                                                 hand_positions_t0)
